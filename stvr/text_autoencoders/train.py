...
parser.add_argument('--dim_emb', type=int, default=64, metavar='D',
                    help='dimension of word embedding')
parser.add_argument('--dim_h', type=int, default=128, metavar='D',
                    help='dimension of hidden state per layer')
parser.add_argument('--nlayers', type=int, default=1, metavar='N',
                    help='number of layers')
parser.add_argument('--dim_d', type=int, default=128, metavar='D',
...
def main(args,trial=None):
    ...
    for epoch in range(args.epochs):
        ...
        if trial is not None:
            trial.report(valid_meters['loss'].avg,epoch)
